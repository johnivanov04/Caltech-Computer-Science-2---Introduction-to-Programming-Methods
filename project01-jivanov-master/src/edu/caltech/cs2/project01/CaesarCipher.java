...
public class CaesarCipher {
     ...
     * your findIndexInAlphabet method when writing this one. This method
     * assumes that 'c' is an upper-case alphabetic character.
     *
     * For example:
     *  rot('A', 0) returns 'A'
     *  rot('A', 1) returns 'B'
     ...
     *  rot('J', 25) returns 'I'
     *
     * @param c the upper-case character to rotate
